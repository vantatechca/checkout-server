from sqlalchemy import Column, Integer, SmallInteger, String, Text, Boolean, Numeric, DateTime
...
class Brand(Base):
    ...
    # NOTE: this DB (Neon, MySQL-migrated) stores `active` as smallint(0/1),
    # not boolean — so the column is SmallInteger here and queries compare == 1.
